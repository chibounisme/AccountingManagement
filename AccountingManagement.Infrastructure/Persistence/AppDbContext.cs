...
public class AppDbContext : DbContext, IAppDbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<User>().HasData(
            ...
            {
                Id = 1, // EF Core needs explicit ID for HasData if generated by DB
                CreatedDate = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc),
                IsActive = true // Explicitly set through calling Activate, but HasData needs direct property set
            }
            // Note: The User entity now has a private constructor. For HasData, either make it public
            // or provide all necessary values directly, or use a factory method if EF supported it here.
            // The User constructor sets IsActive=true. So this should be fine.
        );
    }
}